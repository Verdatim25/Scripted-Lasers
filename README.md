...
WILL PROBABLY BE DEPRECATED BY ANOMALY 1.6 AND ITS SCRIPTED MODULAR ATTACHMENT SYSTEM! (but who knows when thats coming out. You can use this for now, and remove later when it comes out!)  
...
### ADDING LASER COMPATIBILITY TO WEAPONS // CHANGING LASER POSITION ON WEAPONS
